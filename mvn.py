...
class MultivariateNormal(object):
	...
	def add(self,other):
		...
		raise ValueError('addition not supported for type MultivariateNormal and %s' % type(other))

	def subtract(self,other):
		if isinstance(other,MultivariateNormal):
			return MultivariateNormal(self.mean - other.mean,self.cov + other.cov)
		raise ValueError('subtraction not supported for type MultivariateNormal and %s' % type(other))
